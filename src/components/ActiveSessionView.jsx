        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 border-2 border-indigo-600 hover:bg-indigo-100 text-indigo-950 font-black text-xs transition-colors shadow-[2px_2px_0px_0px_rgba(79,70,229,0.3)] active:translate-x-[1px] active:translate-y-[1px]"
            >
              {copiedLink ? (
